...
![Figura 1 - mapas temáticos que destacam os estados correspondentes às capitais selecionadas](img/geral/fig-01-lotes-capitais.png)
...
![Figura 2 - quantitativos de municípios e a representatividade percentual dos endereços do CNEFE por categoria de centralidade urbana](img/geral/fig-02-cnefe-centralidade.png)
...
![Figura 3 - distribuição espacial do percentual da representação dos endereços por municípios do Brasil](img/geral/fig-03-distribuicao-enderecos.jpeg)
...
![Figura 4 - visão consolidada do avanço das atividades e dos lotes de execução do projeto](img/geral/fig-04-status-etapas.png)

![Legenda da Figura 4](img/geral/fig-04-status-legenda.png)
