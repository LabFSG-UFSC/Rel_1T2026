...
O resultado do levantamento inicial das variáveis geográficas podem ser vistos 
no @sec-estr-base.
...
Esse pipeline foi relevante porque estabeleceu uma rotina reprodutível, escalável e tecnicamente consistente para montagem da base cartográfica bruta municipal, integrando fontes oficiais, colaborativas e derivadas de imagens, com padronização de nomenclatura, coerência espacial entre camadas e preparação objetiva dos insumos para as etapas posteriores de qualificação, modelagem e derivação de variáveis geográficas. Maiores detalhes deste pipeline podem ser verificados no @sec-estr-base.
...
: Organização da ingestão de dados no banco de dados Postgresql {#tbl-org-ingestao-dados-no-Postgresql}
...
O Script Python de ingestão e organização de dados é ilustrado pelo código apresentado a seguir.
