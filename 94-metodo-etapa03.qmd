...
```{r}
#| eval: true
knitr::include_graphics("img/fluxo/fluxo-modelagem.png")
```
...
![Fluxo metodológico da classificação de padrão
construtivo.](img/pvg/fluxo-padrao-construtivo.svg){#fig-padrao-construtivo
width="85%"}
...
![Histogramas dos imóveis classificados por padrão construtivo](img/pvg/figura_2.png){#fig-pvg2}

![Distribuição do valor unitário por padrão de imóvel —
Apartamentos.](img/pvg/histograma-padrao-apartamentos.png){#fig-hist-padrao-aptos
width="90%"}
...
![](img/pvg/figura_3.png){#fig-pvg3}

![Distribuição do valor unitário por padrão de imóvel —
Casas.](img/pvg/histograma-padrao-casas.png){#fig-hist-padrao-casas
width="90%"}
...
![Fluxo da classificação espacial por tipologia](img/pvg/figura_4.png){#fig-pvg4}

![Fluxo metodológico do agrupamento espacial por
tipologia.](img/pvg/fluxo-agrupamento.svg){#fig-agrupamento width="85%"}

![](img/pvg/figura_5.png){#fig-pvg5}

![Clusterização espacial por tipologia com comparação entre
class_3_cluster e class_5_cluster (apartamentos, casas e
lotes).](img/pvg/clusterizacao-tipologias-k3-k5.png){#fig-clusterizacao-tipologias
width="95%"}
