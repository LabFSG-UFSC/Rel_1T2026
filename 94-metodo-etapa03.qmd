...
```{r}
knitr::include_graphics("img/fluxo/Fluxo_da_Obtencao_do_Valor_de_Referencia.png")
```
...
construtivo.](img/pvg/figura_1.png){#fig-padrao-construtivo
width="85%"}
...
tipologia.](img/pvg/figura_4.png){#fig-agrupamento width="85%"}
...
lotes).](img/pvg/figura_5.png){#fig-clusterizacao-tipologias
width="95%"}
...
Os gráficos da figura de residuos finais mostram que não há presença de
...
superficie de valores unitarios de lotes.
