...
![Variáveis utilizadas – imóveis edificados](img/pvg/fig-05-variaveis-edificados.png)
...
![Variáveis utilizadas – lotes e terrenos](img/pvg/fig-06-variaveis-lotes.png)
...
A Etapa 3 estruturou um fluxo integrado no qual os modelos não operam de forma isolada. O modelo de imóveis edificados foi utilizado para estimar valores do metro quadrado construído e gerar a variável VUM2, que posteriormente foi incorporada ao modelo de lotes. A Figura 7 ilustra este processo.

![Ilustração fluxo dos modelos](img/pvg/fig-07-fluxo-modelos.png)
