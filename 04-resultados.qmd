...
etapas, dependências e principais processos, encontra-se apresentado no 
@sec-fluxo-metodologico.
...
Valores de Referência. As Figuras -@fig-inter1 a -@fig-inter7 apresentam 
exemplos da interface da plataforma e das funcionalidades atualmente 
configuradas para visualização e análise dos dados territoriais.
